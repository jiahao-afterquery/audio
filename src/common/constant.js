...
const SETUP_PAGE_URL = `${ORIGIN_URL}/setup.html`; // setup page url
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        url: `${ORIGIN_URL}/example/advanced/conversationPlatform/index.html`,
        zhDocUrl: "",
        enDocUrl: "",
        githubUrl:
          "https://github.com/AgoraIO/API-Examples-Web/tree/main/src/example/advanced/conversationPlatform",
      },
    ],
  },
  {
